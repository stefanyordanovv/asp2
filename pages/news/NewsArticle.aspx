...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="container">
        ...
        <div class="container">
            <asp:ListView ID="LV_NewArticle" runat="server" DataSourceID="SqlDataSource1">
                <ItemTemplate>
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><%# Eval("Title") %>
                                <small>by <a href="#"><%# Eval("Author") %></a>
                                </small>
                            </h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <hr>
                            <!-- Date/Time -->
                            <p><i class="fa fa-clock-o"></i><%# Eval("CreateDate") %></p>
                            <hr>
                            <!-- Preview Image -->
                            ...
                            <hr>
                            <asp:Button ID="Button_Back" CssClass="btn btn-success btn-lg" runat="server" Text="Назат" OnClientClick="JavaScript:window.history.back(1); return false;"/>
                            <hr />
                </ItemTemplate>
            </asp:ListView>
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT * FROM [News] WHERE ([id] = @id)">
                <SelectParameters>
                    <asp:SessionParameter SessionField="NewsID" Name="id" Type="Int32"></asp:SessionParameter>
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
        <!-- Blog Comments -->
